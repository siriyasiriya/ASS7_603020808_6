package com.example.ass7_603020808_6
...
class MainActivity : AppCompatActivity() {
    ...
    private fun  testEmployeeDate() {
        EmployeeList.add(Employee("Siriya" ,"Female", "siriyaboonlad22@gmail.com" ,150000))
        EmployeeList.add(Employee("siriyaboonlad" ,"Female", "siriyaboonlad@kkumail.com" ,100000))
    }
}